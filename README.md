...
![MiniWoB](https://github.com/tommi1612/drlrpa/raw/master/imgs/MiniWoB.jpg "MiniWoB")
...
The following installation commands are grounded on a linux system.

```
conda create --name universe-starter-agent python=3.5
source activate universe-starter-agent

sudo apt-get install -y golang libjpeg-turbo8-dev make tmux htop cmake golang libjpeg-dev
...
Concluding it is important to build the [newDockerImage](https://github.com/tommi1612/drlrpa/tree/master/newDockerImage) and to replace the runtimes.yml file at the location where universe is installed with the [given one](https://github.com/tommi1612/drlrpa/tree/master/universe/universe/runtimes.yml).
...
![tensorboardIdentifyShape](https://github.com/tommi1612/drlrpa/raw/master/imgs/tbIdentifyShape.png "tensorboardIdentifyShape")
...
![ClickTestVNC](https://github.com/tommi1612/help/drlrpa/master/imgs/ClickTestVNC.png "ClickTestVNC")
